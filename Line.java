...
public class Line {
    ...
    public String toString() {
        return "Line[begin=" + begin + ",end=" + end + "]"; // Invoke begin.toString() and end.toString()
    }
    ...
    // Return the distance from this line to the given point with coords
    public double distance(int x, int y) {
        double xDiffBegin2Point = x - begin.getX(); // position of point rel one end of line
        double yDiffBegin2Point = y - begin.getY();
        double xDiff = end.getX() - begin.getX(); // vector along line
        double yDiff = end.getY() - begin.getY();
        double E = -yDiff; // orthogonal vector
        double F = xDiff;

        double dot = xDiffBegin2Point * E + yDiffBegin2Point * F;
    ...
    public double distance(Point p) {
        double xDiffBegin2Point = p.getX() - begin.getX(); // position of point rel one end of line
        double yDiffBegin2Point = p.getY() - begin.getY();
        double xDiff = end.getX() - begin.getX(); // vector along line
        double yDiff = end.getY() - begin.getY();
        double E = -yDiff; // orthogonal vector
        double F = xDiff;
    ...
    public boolean intersects(Line another) {
        return (this.getGradient() == another.getGradient()) ? false : true;
    }
}
