...
public class TestLine {
    public static void main(String[] args) {
        ...
        // Test distance()
        System.out.printf("distance from (10, 20) is: %.2f%n", l1.distance(10, 20));
        Point temp = new Point(10, 20);
        System.out.printf("distance from (10, 20) is: %.2f%n", l1.distance(temp));

        // Test intersects()
        Line another = new Line(3, 5, 5, 6);
        System.out.println(l1.intersects(another));
    }
}
