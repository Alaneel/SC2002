...
public class SwingAccumulator extends JFrame {
    ...
    public SwingAccumulator() {
        ...
        cp.setLayout(new GridLayout(2, 2, 5, 5)); // The content-pane srts its layout
        ...
        // Allocate an anonymous instance of an anonymous inner class that implements ActionListener as ActionEvent Listener
