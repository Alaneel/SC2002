...
/*
 * This program contains a boolean method called isMagic(int number), which tests if the given number contains the digit 8
 */
...
public class MagicNumber {
    ...
    /*
     * Check if the given int contains the digit 8
