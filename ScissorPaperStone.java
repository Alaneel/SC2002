    ...
    public static void main(String[] args) {
        ...
        while (!gameOver) {
            ...
            do {
                ...
                char inChar = in.next().toLowerCase().charAt(0); // Convert to lowercase and extract frist char
            ...
            if (!gameOver) {
                // Computer Move
                // Generate a random int 0 to 2, which happens to corresponds to the ordinal of the elements of the enum
        ...
        // Print statistics
        System.out.println("\nnumber of trails: " + numTrials);
        System.out.printf("I won %d(%.2f%%). You won %d(%.2f%%). Tie %d(%.2f%%)%n", numComputerWon, 100.0*numComputerWon/numTrials, numPlayerWon, 100.0*numPlayerWon/numTrials, numTie, 100.0*numTie/numTrials);
