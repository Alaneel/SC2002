import java.awt.*; // Using AWT container and component calsases
import java.awt.event.*; // Using AWT event classes and listener interfaces

// An AWT GUI program inherits (customized) from the top-level container java.awt.Frame
public class AWTAccumulator extends Frame {
    ...
    public AWTAccumulator() {
        setLayout(new GridLayout(2, 2)); // "super" Frame (Container) sets layout to GridLayout of 2 rows and 2 columns
        ...
        // The source add an anonymous instance of TFInputListener as an ActionEvent listener, which provides an ActionEvent handler called actionPerformed()
