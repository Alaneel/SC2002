...
public class WindowEventDemo extends Frame {
    ...
    public WindowEventDemo() {
        ...
        // btnCount adds an anonymous instance of BtnCountListener as a WindowEvent listener

        addWindowListener(new MyWindowListener());
        // "super" Frame(source object) fires WindowEvent
        // "super" Frame adds an anonymous instance of MyWindowListener as a WindowEvent listener
