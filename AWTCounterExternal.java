...
public class AWTCounterExternal extends Frame {
    ...
    public AWTCounterExternal() {
        ...
        // "super" Frmae, which is a Container, sets its layout to FlowLayout to arrange the components from left-to-right, and flow to next row from top-to-bottom
        ...
        // The source add an instance of MyExternalBtnListener as an ActionEvent listener, which provides an ActionEvent handler called actionPerformed()
        // Clicking "btnCount" invokes actionPerformed()

        setTitle("AWT Counter"); // "super" Frame sets its title
        setSize(250, 100); // "super" Frame sets its intial window size
...
// This class must implement ActionListener interface and override the actionPerformed() method
