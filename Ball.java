/*
 * The Ball class models a moving ball at (x, y) with displacement per move-step of (xStep, yStep)
 */
public class Ball {
    ...
    // Return the xStep and yStep in a 2-element double array
    ...
    // Returns "this" instance to support chaining operation
    public Ball move() {
        x += xStep;
        y += yStep;
        return this;
