...
public class CircleComputation { // Save as "CircleComputation.java"
    public static void main(String[] args) { // The programming statements inside the main() method are executed in a sequential manner
        ...
        // Declare as "final" to specify that its value connot be changed (i.e. constant)
