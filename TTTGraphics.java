...
public class TTTGraphics extends JFrame {
    ...
    public static final Color COLOR_NOUGHT = new Color(76, 181, 245); // Blue #4CB5P5
    ...
    // 2. Cell's contents: CROSS, NOUGHT and NO_SEED
    public enum Seed {
     ...
     * Update cells[selectedRow][selectedCol]
            ...
            for (int row = 0; row < ROWS; ++row) {
                for (int col = 0; col < COLS; ++col) {
                    if (board[row][col] == Seed.NO_SEED) {
                        return State.PLAYING; // still have empty celss
                    }
                }
            }
    ...
    class GamePanel extends JPanel {
        ...
        public void paintComponent(Graphics g) { // Callback via repaint()
            ...
            // Use Graphics 2D which allows us to set the pen's stroke
