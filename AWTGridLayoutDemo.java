...
// An AWT GUI class program inherits the top-level container java.awt.Frame
public class AWTGridLayoutDemo extends Frame {
    ...
    public AWTGridLayoutDemo() {
        ...
        // "super" Frame sets layout to 3*2 GridLayout, horizontal and vertical gaps of 3 pixels
